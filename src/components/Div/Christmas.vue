...
.christmas-section {
  ...
  background: linear-gradient(135deg, var(--christmas-deep) 0%, var(--christmas-green) 60%, var(--christmas-leaf) 100%);
...
.btn-buy:hover {
  ...
  box-shadow: var(--shadow-christmas-md);
}
